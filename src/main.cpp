 ...
 *                                                                    *
 *    Used AtMega328p microcontroller, driver A4988(as the internal)  *
 *  and as an external used TB6600 driver for the more power motor.   *
 *  Also can be use any step-dir driver as external.                  *
 *  Together with the internal driver, the MITSUMI M42SP-7 motor was  *
 *  used, which has a 7.5 degree rotation angle. Step signal is       *
 *  generated by Timer1(16bit) interrupt.                             *
 *                                                                    *
